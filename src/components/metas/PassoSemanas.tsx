...
import { cardStyle, inputStyle } from '@/components/metas/metasUi'
  ...
  return (
    <div style={cardStyle}>
      ...
      <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 8 }}>
        {semanas.map(s => (
          <div key={s.numero} style={{ display: 'flex', gap: 16, padding: '10px 14px', background: 'var(--ws-bg)', borderRadius: 'var(--radius-sm)', fontSize: 13 }}>
