...
export const COMUNIDADE_LEGACY_ATUAL: ComunidadeLegacy = {
  ...
  quadrantes: [
    { tier: 'ok',  pct: 29, label: 'Dentista com clínica',    aprox: '~31 pessoas · ICP alto' },
    { tier: 'mid', pct: 36, label: 'Dentista sem clínica',    aprox: '~39 · quer abrir/comprar franquia' },
    { tier: 'mid', pct: 28, label: 'Não-dentista sem clínica', aprox: '~30 · perfil investidor puro' },
